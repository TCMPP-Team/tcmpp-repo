Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/TZImagePickerController/3.8.2.1/TZImagePickerController_3.8.2.1.zip' }
  s.requires_arc = true
