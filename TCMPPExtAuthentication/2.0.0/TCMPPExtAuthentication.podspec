Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/TCMPPExtAuthentication/2.0.0/TCMPPExtAuthentication_2.0.0.xcframework.zip' }
