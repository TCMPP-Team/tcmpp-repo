Pod::Spec.new do |s|
  ...
  s.homepage     = "https://git.code.oa.com/groot-components/TCMPPExtLive"
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tmf/ios-sdk/TCMPPExtLive/1.5.0/TCMPPExtLive.zip' }
