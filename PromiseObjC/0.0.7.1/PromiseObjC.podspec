Pod::Spec.new do |s|
  ...
  s.source      = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/PromiseObjC/0.0.7.1/PromiseObjC_0.0.7.1.zip' }
  ...
  s.module_name = 'TFBLPromises'
  s.prefix_header_file = false
  s.header_dir = "./"
  s.public_header_files = "Sources/FBLPromises/include/**/*.h"
  s.private_header_files = "Sources/FBLPromises/include/TFBLPromisePrivate.h"
