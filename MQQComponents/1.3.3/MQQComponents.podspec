Pod::Spec.new do |s|
   ...
   s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tmf/ios-sdk/MQQComponents/1.3.3/MQQComponents.zip' }
   ...
   s.libraries    = "c", "c++", "z.1.2.5", "sqlite3.0"
