Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/TCSASExtNFC/2.0.0/TCSASExtNFC_2.0.0.xcframework.zip' }
  s.ios.deployment_target = "13.0"
  s.source_files = "TCSASExtNFC/Classes/**/*"
  s.public_header_files = "TCSASExtNFC/Classes/*.h"
  s.requires_arc = true
  ...
  s.vendored_libraries = "Libraries/libTCSASExtNFC.a"
end
