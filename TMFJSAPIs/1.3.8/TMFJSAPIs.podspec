Pod::Spec.new do |s|
  ...
  s.description   = <<-DESC
                      TMFJSAPIs - Common API covers basic information
                      DESC
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tmf/ios-sdk/TMFJSAPIs/1.3.8/TMFJSAPIs.zip' }
  ...
  s.subspec "TMFJSAPIs_Hybrid" do |ss|
    ss.source_files         = "Headers/TMFJSAPIs_Hybrid/*.h"
    ss.public_header_files  = "Headers/TMFJSAPIs_Hybrid/*.h"
    ss.vendored_libraries = "Libraries/libTMFJSAPIs_Hybrid.a"
    ss.dependency "TMFHybrid"
  end
