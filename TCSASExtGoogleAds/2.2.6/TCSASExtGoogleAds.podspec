Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/TCSASExtGoogleAds/2.2.6/TCSASExtGoogleAds_2.2.6.xcframework.zip' }
