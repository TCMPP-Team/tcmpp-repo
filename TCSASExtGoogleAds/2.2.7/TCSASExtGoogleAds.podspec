Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/TCSASExtGoogleAds/2.2.7/TCSASExtGoogleAds_2.2.7.xcframework.zip' }
