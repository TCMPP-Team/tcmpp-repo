Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tmf/ios-sdk/TMFShare/1.2.7/TMFShare.zip' }
  ...
  s.subspec "TMFShare_Weibo" do |ss|
    ...
    ss.dependency "Weibo_SDK", "~> 3.3.7"
  end
  s.subspec "TMFShare_WXWork" do |ss|
    ss.vendored_libraries = "Libraries/libTMFShare_WXWork.a"
