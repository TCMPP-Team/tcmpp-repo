Pod::Spec.new do |s|
  ...
  s.source       = { :http => 'https://tmf-warehouse-1314481471.cos.ap-beijing.myqcloud.com/tcmpp/ios-sdk/TCSASExtPlaylet/2.3.8/TCSASExtPlaylet_2.3.8.zip' }
  ...
  s.resource = '**/TUIDramaPlayer.bundle'
  s.vendored_frameworks   = "TCSASExtPlaylet.xcframework","TUIPlayerShortVideo.xcframework","TUIPlayerCore.xcframework"
end
